...
public enum IngredientEnum {
    ...
    IngredientEnum(String friendlyName, ArrayList<OxideQuantity> oxides) {
        name = friendlyName;
        this.oxides = oxides;
    }

    IngredientEnum(String friendlyName, OxideQuantity... oxides) {
        name = friendlyName;
        Collections.addAll(this.oxides,oxides);
    }

    IngredientEnum(String friendlyName, String oxidesLongString) {
        name = friendlyName;
    ...
    private static final Map<String, IngredientEnum> valueMap;
    static {
        final Map<String, IngredientEnum> initMap = new HashMap<String, IngredientEnum>();
        for (final IngredientEnum e : IngredientEnum.values())
            initMap.put(e.name,e);
        valueMap = initMap;
    }

    public static IngredientEnum getEnum(String name) {
